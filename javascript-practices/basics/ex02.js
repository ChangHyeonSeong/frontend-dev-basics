...
2. 호스트 객체
   ...
   호스트 환경이 브라우져라면: document, location, XmlHttpRequest, window, ....
...
//기본타입이 코드로 불려질때 유사객체가 만들어져서 실행된다

console.log("====== [객체1] (object type) ====================");
var i2 = new Number(1);                  //함수로 객체를 만든다 생성자함수  관례로 이름 대문자 시작
...
console.log("====== 원시타입도 메소스 호출이 가능하다. ====================");
